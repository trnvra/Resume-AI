...
const Home = () => {
    ...
    if (data) {
        // 🎯 1. History ke liye naya session initialize karein
        const existingSessions = JSON.parse(localStorage.getItem('user_interview_sessions') || '[]');
        
        const newSession = {
            sessionId: 'session_' + Date.now(),
            interviewId: data._id, // 👈 Future reference ke liye
